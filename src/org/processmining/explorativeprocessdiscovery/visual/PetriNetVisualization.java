...
public class PetriNetVisualization {
	...
	public PetriNetVisualization(PluginContext context, PetrinetGraph origNet) {
		this.MJP = visualizeWithAll(context, origNet);
	}

	protected JPanel visualizeWithAll(PluginContext context, PetrinetGraph n) {
...
//		return panel;
		...
		tempPanel.add(panel.getComponent());
